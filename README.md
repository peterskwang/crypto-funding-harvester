...
- [`crypto_trend_strategy/`](crypto_trend_strategy/README.md) — a multi-asset crypto trend-following strategy, walk-forward validated (honest result: out-of-sample underperforms buy-and-hold). Temporarily housed here pending its own repo. Unrelated to the funding harvester above.
